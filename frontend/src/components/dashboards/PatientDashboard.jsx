      ...
      <main className="flex-1 overflow-auto" style={{ padding: "0 32px 32px", maxWidth: 1400, margin: "0 auto", width: "100%" }}>
        ...
        {patientTab === "past" && (
          <div className="glass-card" style={{ padding: 32 }}>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              {isHistoryLoading ? (
                <p style={{ color: "var(--text-secondary)" }}>Loading appointment history...</p>
              ) : isHistoryError ? (
                <p style={{ color: "var(--text-secondary)" }}>Could not load appointment history.</p>
                ...
                patientPast.map((appt) => {
                  ...
                  return (
                    <div key={appointmentId} className="glass-card" style={{ padding: 20 }}>
                      ...
                      {appt.notes ? (
                        <p style={{ color: "var(--cyan-bright)", fontSize: "0.9rem", margin: "8px 0 0 0" }}>Notes: {appt.notes}</p>
                      ) : null}
  ...
  return (
    <div className="glass-card" style={{ padding: 20, borderLeft: `4px solid ${borderColor}`, position: "relative" }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        <button onClick={() => rescheduleAppointment(apptId)} className="btn-secondary" style={{ padding: "8px 16px", fontSize: "0.85rem" }}>
          Reschedule
        </button>
        <button onClick={() => cancelAppointment(apptId)} className="btn-danger" style={{ padding: "8px 16px", fontSize: "0.85rem" }}>
          Cancel
        </button>
      </div>
    </div>
